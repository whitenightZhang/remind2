...
reportFE <- function(gdx, regionSubsetList = NULL,
  ...
  if (indu_mod == 'subsectors') {
    ...
    if (chemicals_process_based) {
      ...
      routes_HVC        <- c("hvc_stCrLiq", "hvc_stCrNg", "hvc_meSol", "hvc_meBio", "hvc_meNg", "hvc_meLiq", "hvc_meSol_gh2", "hvc_meBio_gh2", "hvc_meSol_cc", "hvc_meBio_cc", "hvc_meNg_cc", "hvc_meLiq_cc", "hvc_meh2","hvc_stCrChemRe","hvc_mechemRe","mech_recycle")
      ...
      routes_meFinal    <- c("meFinal_sol", "meFinal_bio", "meFinal_ng", "meFinal_liq", "meFinal_sol_gh2", "meFinal_bio_gh2", "meFinal_sol_cc", "meFinal_bio_cc", "meFinal_ng_cc", "meFinal_liq_cc", "meFinal_h2","meFinal_chemRe")
      ...
      tech_methanol     <- c("meSySol", "meSyBio", "meSyNG", "meSyLiq", "meSySol_cc", "meSyBio_cc", "meSyNG_cc", "meSyLiq_cc", "meSyH2")
      ...
      mixer <- tribble(
        ...
        "FE|Industry|Chemicals|HVC|+|From bio-based methanol (EJ/yr)",                       NULL,      NULL,          "hvc_meBio",                                  "chemicals",
        ...
        "FE|Industry|Chemicals|HVC|+|From bio and green hydrogen-based methanol (EJ/yr)",    NULL,      NULL,          "hvc_meBio_gh2",                              "chemicals",
        "FE|Industry|Chemicals|HVC|+|From solids-based methanol with CC (EJ/yr)",            NULL,      NULL,          "hvc_meSol_cc",                               "chemicals",
        "FE|Industry|Chemicals|HVC|+|From bio-based methanol with CC (EJ/yr)",               NULL,      NULL,          "hvc_meBio_cc",                               "chemicals",
        ...
        "FE|Industry|Chemicals|HVC|+|From green hydrogen-based methanol (EJ/yr)",            NULL,      NULL,          "hvc_meh2",                                   "chemicals",
        ...
        "FE|Industry|Chemicals|Methanol Final|+|Bio-based (EJ/yr)",                          NULL,      NULL,           "meFinal_bio",                               "chemicals",
        ...
        "FE|Industry|Chemicals|Methanol Final|+|Bio and green hydrogen-based (EJ/yr)",       NULL,      NULL,           "meFinal_bio_gh2",                           "chemicals",
        "FE|Industry|Chemicals|Methanol Final|+|Solids-based with CC (EJ/yr)",               NULL,      NULL,           "meFinal_sol_cc",                            "chemicals",
        "FE|Industry|Chemicals|Methanol Final|+|Bio-based with CC (EJ/yr)",                  NULL,      NULL,           "meFinal_bio_cc",                            "chemicals",
        ...
        "FE|Industry|Chemicals|Methanol|+|Bio and green hydrogen-based (EJ/yr)",             NULL,      "meSyBio",      c("meFinal_bio_gh2", "hvc_meBio_gh2"),       "chemicals",
        ...
        "FE|Industry|Chemicals|Methanol|+|Bio-based with CC (EJ/yr)",                        NULL,      c("meSyBio","meSyBio_cc"),    c("meFinal_bio_cc", "hvc_meBio_cc"),         "chemicals",
      ...
      # TODO: think about routes in chemicals
       mixer <- tribble(
         ~variable,                                                                                   ~mat,         ~route, 
          ...
          "Production|Industry|Chemicals|HVC|+|From bio-based methanol (Mt/yr)",                       "hvc",        "hvc_meBio",    
          ...
          "Production|Industry|Chemicals|HVC|+|From bio and green hydrogen-based methanol (Mt/yr)",    "hvc",        "hvc_meBio_gh2",
          "Production|Industry|Chemicals|HVC|+|From solids-based methanol with CC (Mt/yr)",            "hvc",        "hvc_meSol_cc",
          "Production|Industry|Chemicals|HVC|+|From bio-based methanol with CC (Mt/yr)",               "hvc",        "hvc_meBio_cc",
          ...
          "Production|Industry|Chemicals|HVC|+|From green hydrogen-based methanol (Mt/yr)",            "hvc",        "hvc_meh2",
          ...
          "Production|Industry|Chemicals|Methanol Final|+|Bio and green hydrogen-based (Mt/yr)",       "methFinal",  "meFinal_bio_gh2",
          "Production|Industry|Chemicals|Methanol Final|+|Solids-based with CC (Mt/yr)",               "methFinal",  "meFinal_sol_cc",
          "Production|Industry|Chemicals|Methanol Final|+|Bio-based with CC (Mt/yr)",                  "methFinal",  "meFinal_bio_cc",
          ...
          "Production|Industry|Chemicals|Methanol|+|Bio and green hydrogen-based (Mt/yr)",             "methanolH2", c("hvc_meBio_gh2","meFinal_bio_gh2"),
          "Production|Industry|Chemicals|Methanol|+|Solids-based with CC (Mt/yr)",                     "methanol",   c("hvc_meSol_cc", "meFinal_sol_cc"),
          "Production|Industry|Chemicals|Methanol|+|Bio-based with CC (Mt/yr)",                        "methanolH2",   c("hvc_meBio_cc", "meFinal_bio_cc"),
