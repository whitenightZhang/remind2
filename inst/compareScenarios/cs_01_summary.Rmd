...
```{r Captured Carbon Prices}
showLinePlots(data, "Price|Carbon|Captured")
showRegiLinePlots(data, "Price|Carbon|Captured")
```

```{r CCU Prices}
showLinePlots(data, "Price|Carbon|CCU")
showRegiLinePlots(data, "Price|Carbon|CCU")
```
