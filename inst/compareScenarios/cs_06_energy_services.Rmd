...
if ("Production|Industry|Chemicals|Ammonia|Gas-based" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|Ammonia|Import Ammonia",
    "Production|Industry|Chemicals|Ammonia|Export Ammonia"
    )
  # Non-process based scenarios have tot variable, but not items, which leads to errors in display;
  # Therefore, filter data by scenarios that have the 'items' variables.
  dscens <- data %>%
...
### Ammonia trade using process-based chemicals modeling
```{r Ammonia trade by route}
if ("Production|Industry|Chemicals|Ammonia|Gas-based" %in% levels(data$variable)){ # if process-based chemicals is used
  tot <- "Production|Industry|Chemicals|Ammonia"
  items <- c(
    "Production|Industry|Chemicals|Ammonia|Import Ammonia",
...
if ("Production|Industry|Chemicals|Fertilizer|From gas-based ammonia" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|Fertilizer|Import Ammonia"
    )
...
if ("Production|Industry|Chemicals|HVC|From liquids-based steam cracker" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|HVC|From bio-based methanol",
    ...
    "Production|Industry|Chemicals|HVC|From bio and green hydrogen-based methanol",
    "Production|Industry|Chemicals|HVC|From solids-based methanol with CC",
    "Production|Industry|Chemicals|HVC|From bio-based methanol with CC",
    ...
    "Production|Industry|Chemicals|HVC|From green hydrogen-based methanol",
    ...
    "Production|Industry|Chemicals|HVC|From Import Methanol"
    )
  # Non-process based scenarios have tot variable, but not items, which leads to errors in display;
  # Therefore, filter data by scenarios that have the 'items' variables.
  dscens <- data %>%
...
if ("Production|Industry|Chemicals|Methanol|Gas-based" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|Methanol|Bio-based",
    ...
    "Production|Industry|Chemicals|Methanol|Bio and green hydrogen-based",
    "Production|Industry|Chemicals|Methanol|Solids-based with CC",
    "Production|Industry|Chemicals|Methanol|Bio-based with CC",
    ...
    "Production|Industry|Chemicals|Methanol|Import Methanol",
    "Production|Industry|Chemicals|Methanol|Export Methanol"
    )
  # Non-process based scenarios have tot variable, but not items, which leads to errors in display;
  # Therefore, filter data by scenarios that have the 'items' variables.
  dscens <- data %>%
...
### Methanol trade using process-based chemicals modeling
```{r Methanol trade by route}
if ("Production|Industry|Chemicals|Methanol|Gas-based" %in% levels(data$variable)){ # if process-based chemicals is used
  tot <- "Production|Industry|Chemicals|Methanol"
  items <- c(
    "Production|Industry|Chemicals|Methanol|Import Methanol",
...
if ("Production|Industry|Chemicals|Ammonia Final|Gas-based" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|Ammonia Final|Import Ammonia"
    )
  # Non-process based scenarios have tot variable, but not items, which leads to errors in display;
  # Therefore, filter data by scenarios that have the 'items' variables.
  dscens <- data %>%
...
if ("Production|Industry|Chemicals|Methanol Final|Gas-based" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|Methanol Final|Bio-based",
    ...
    "Production|Industry|Chemicals|Methanol Final|Bio and green hydrogen-based",
    "Production|Industry|Chemicals|Methanol Final|Solids-based with CC",
    "Production|Industry|Chemicals|Methanol Final|Bio-based with CC",
    ...
    "Production|Industry|Chemicals|Methanol Final|Import Methanol"
    )
  # Non-process based scenarios have tot variable, but not items, which leads to errors in display;
  # Therefore, filter data by scenarios that have the 'items' variables.
  dscens <- data %>%
